...
uint8_t button_getButton() {
    ...
    int pressed_button = 9;

    if(!((GPIO_PORTE_DATA_R)&1)){
        pressed_button = MIN(1,pressed_button);
    }

    if (!((GPIO_PORTE_DATA_R >> 1)&1)){
        pressed_button = MIN(2, pressed_button);
    }

    if (!((GPIO_PORTE_DATA_R >> 2)&1)){
        pressed_button = MIN(3, pressed_button);
    }

    if (!((GPIO_PORTE_DATA_R >> 3)&1)){
        pressed_button = MIN(4, pressed_button);
    }

    if (!((GPIO_PORTE_DATA_R >> 4)&1)){
        pressed_button = MIN(5, pressed_button);
    }

    if (!((GPIO_PORTE_DATA_R >> 5)&1)){
        pressed_button = MIN(6, pressed_button);
    }
	...
	return pressed_button; // REPLACE ME
}
